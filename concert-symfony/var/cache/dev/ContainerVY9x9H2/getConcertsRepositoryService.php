...
// Returns the private 'App\Repository\ConcertsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ConcertsRepository.php';

return $this->privates['App\\Repository\\ConcertsRepository'] = new \App\Repository\ConcertsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
